...
// as URL and parse might only accept non-ip-address urls
    try {
        ...
        const results = constructResultsDict(rawURL, cleanFullURL, tldtsURL, cleanHostnameNoTLD, cleanHostNameWithTLD, parsedURL);
        ...
        const resultST3 = await stage3_extraction();
        Object.assign(results, resultST2,resultST3);
