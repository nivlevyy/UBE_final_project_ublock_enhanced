...
export const UBEProcessing = {
    handleProcessingSuccess(tabId, url, combinedResults) {
        ...
        ////////////////////new code/////////////////////
        // if (combinedResults['Prediction'] === 1) {
        //     UBECore.addPhishingUrl(url);
        // }
        ////////////////////new code/////////////////////
        const activeProcessingData = UBECore.getActiveProcessing(tabId);

        if (activeProcessingData) {
            ubolog(`${UBECore.LOG_ICONS.SUCCESS} UBE: Successfully processed Tab ${tabId}`);
            ...
            UBECore.sendAnalysisStatusMessage({
                ...
                tabId: tabId,
                result: combinedResults['Prediction']
            });
    ...
    async processNext() {
        ...
        if (UBECore.hasResult(tabId)) {
            UBECore.removeResult(tabId);
        }
        ...
        try {
            ...
            this.handleProcessingSuccess(tabId, url, finalResults);
            //////////////////////////////////////////////////////////////////////////////////////////
            UBENetwork.reportPrediction(url, finalResults['Prediction'])
             .catch(e => ubolog(`${UBECore.LOG_ICONS.WARNING} UBE-Net: reportPrediction error: ${e}`));
            ///////////////////////////////////////////////////////////////////////////////////////////
        } catch (error) {
