...
function displayResultsData(data) {
    ...
    const predText = data.result['Prediction'] || 'N/A';
    const statusClass = predTextStyle[predText] || 'status-error';
    ...
    html += `<div class="section">
                 ...
                 <div class="item">
                    ...
                    <span class="value status-safe">Complete</span>
                 </div>
                 <div class="item">
                    <div class="key">Assessment:</div>
                    <span class="value ${statusClass}">${predText}</span>
                 </div>
             </div>`;
    ...
    if (resultData && typeof resultData === 'object') {
        for (const [key, value] of Object.entries(resultData)) {
            if (['timestamps', 'executionTimes', 'url', 'prediction'].includes(key)) continue;
