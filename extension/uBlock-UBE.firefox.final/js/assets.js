...
function getAssetSourceRegistry() {
    if ( assetSourceRegistryPromise === undefined ) {
        assetSourceRegistryPromise = cacheStorage.get(
            ...
            }).then(async details => { //changed to async details
...
// async function ubeInitAssets() {
//     await getAssetSourceRegistry();

//     await assets.registerAssetSource('ube-model', {
//         content: 'model',
...
//     await assets.registerAssetSource('ube-api-key', {
//         content: 'api-key',
...
//         updateAfter: 1
//     });
//    await assets.registerAssetSource( 'phishing-UBE', {
//      content: 'filters',
//      group:   'malware',           
//      title:   'Phishing Block List by Niv',
//      contentURL: [
//     "https://raw.githubusercontent.com/nivlevyy/ube_dynamic_list/main/phishing.txt" //ALREDY WORKS ADDING OUR LIST TO FILTERS
//      ],
//      off: false,                    
